...
5. Use the Care Bench during preparation. Its main task-panel card shows when it is ready and keeps active jobs visible. Repot root-bound stock, rehabilitate stressed rescue plants, or propagate a thriving mature plant. Jobs use coins or Bloom and finish on a later morning.
...
8. Balance stock range against daily costs. Unsold plants stay in the shop, use capacity, and slowly become root-bound. The Delivery Rack raises capacity from 12 to 16 plants. Display Shelves add four real display spots and raise the combined maximum to 20.
